...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        // shadow-pop and a slight zoom, now that the animation utilities these
        // classes were written against actually exist (see styles.css).
        'bg-popover text-popover-foreground shadow-pop z-50 min-w-[12rem] overflow-hidden rounded-lg border p-1',
